...
contract('Vinduino', function(accounts) {
   ...
   before(async function() {
      ...
      for (let i = 0; i < 4; i++) {
         ...
         global.data[i].hash = await Utils.deployed().then(function(instance) {
            return instance.calculate_sha256.call(global.data[i].sensor2, global.data[i].sensor1, global.data[i].sensor05, global.data[i].sensor005,
   ...
   it("Data can be inserted by the authorized raspberry using a correct digital signature.", function() {
      return Vinduino.deployed().then(function(instance) {
         return instance.post(global.data[0].sensor2, global.data[0].sensor1, global.data[0].sensor05,
   ...
   it("Data can't be inserted by the authorized raspberry using a wrong digital signature.", function() {
         return Vinduino.deployed().then(function(instance) {
            return !instance.post(global.data[1].sensor2, global.data[1].sensor1, global.data[1].sensor05, global.data[1].sensor005,
   ...
   it("Data can't be inserted by the unauthorized raspberry using a correct digital signature.", function() {
      return Vinduino.deployed().then(function(instance) {
         return !instance.post(global.data[2].sensor2, global.data[2].sensor1, global.data[2].sensor05, global.data[2].sensor005,
   ...
   it("Data can't be inserted by the unauthorized raspberry using a wrong digital signature.", function() {
      return Vinduino.deployed().then(function(instance) {
         return !instance.post(global.data[3].sensor2, global.data[3].sensor1, global.data[3].sensor05, global.data[3].sensor005,
