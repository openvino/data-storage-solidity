...
contract('VinduinoData', function(accounts) {
   ...
   global.data = [
      {sensor2: 493, sensor1: 231, sensor05: 234, sensor005: 123, battery: 4.56, temperature: 27.21},
      {sensor2: 341, sensor1: 567, sensor05: 546, sensor005: 349, battery: 5.11, temperature: 32.43},
      {sensor2: 764, sensor1: 123, sensor05: 103, sensor005: 565, battery: 4.93, temperature: 17.15},
      {sensor2: 443, sensor1: 732, sensor05: 654, sensor005: 343, battery: 3.21, temperature: 31.37},
   ];
   ...
   before(async function() {
      ...
      for (let i = 0; i < 4; i++) {
         ...
         global.data[i].hash = await Utils.deployed().then(function(instance) {
                                                               return instance.calculate_sha256.call(global.data[i].sensor2,
         ...
         Vinduino.deployed().then(async function(instance) {
            return Vinduino.deployed().then(function(instance) {
               return instance.post(global.data[i].sensor2, global.data[i].sensor1, global.data[i].sensor05,
   ...
   it("Data can be consulted correctly. [0]", function() {
       return VinduinoData.deployed().then(async function(instance) {
         ...
         return data[0].toNumber() == global.data[0].sensor2 && data[0].toNumber() == global.data[0].sensor1 &&
                data[0].toNumber() == global.data[0].sensor05 && data[0].toNumber() == global.data[0].sensor005 &&
                data[0].toNumber() == global.data[0].battery && data[0].toNumber() == global.data[0].temperature
      })
   });
   ...
   it("Data can be consulted correctly. [1]", function() {
       return VinduinoData.deployed().then(async function(instance) {
         ...
         return data[1].toNumber() == global.data[1].sensor2 && data[1].toNumber() == global.data[1].sensor1 &&
                data[1].toNumber() == global.data[1].sensor05 && data[1].toNumber() == global.data[1].sensor005 &&
                data[1].toNumber() == global.data[1].battery && data[1].toNumber() == global.data[1].temperature
      })
   });
   ...
   it("Data can be consulted correctly. [2]", function() {
       return VinduinoData.deployed().then(async function(instance) {
         ...
         return data[2].toNumber() == global.data[2].sensor2 && data[2].toNumber() == global.data[2].sensor1 &&
                data[2].toNumber() == global.data[2].sensor05 && data[2].toNumber() == global.data[2].sensor005 &&
                data[2].toNumber() == global.data[2].battery && data[2].toNumber() == global.data[2].temperature
      })
   });
   ...
   it("Data can be consulted correctly. [3]", function() {
       return VinduinoData.deployed().then(async function(instance) {
         ...
         return data[3].toNumber() == global.data[3].sensor2 && data[3].toNumber() == global.data[3].sensor1 &&
                data[3].toNumber() == global.data[3].sensor05 && data[3].toNumber() == global.data[3].sensor005 &&
                data[3].toNumber() == global.data[3].battery && data[3].toNumber() == global.data[3].temperature
      })
   });
